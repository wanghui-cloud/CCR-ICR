...
def parse_args():
    ...
    parser.add_argument("--dataset", dest="dataset", help="test dataset", default="V2C", type=str,)
    # 训练的模型.pth文件的存放地址
    parser.add_argument("--model_dir", dest="model_dir", help="directory to load models",
                        default="../data/experiments/DA_Faster_ICR_CCR/V2C/model/V2C_", type=str,)
    # begin_epoch
    parser.add_argument("--begin_epoch", dest="begin_epoch", help="begin epoch", default=15, type=str,)
    # end_epoch
    parser.add_argument("--end_epoch", dest="end_epoch", help="end epoch", default=30, type=str,)
