...
def parse_args():
    ...
    """
    # action= store_true，命令行指定为True。未指定时默认为False
    parser = argparse.ArgumentParser(description="Test a Faster R-CNN network")
    parser.add_argument("--dataset", dest="dataset", help="test dataset", default="C2F", type=str,)
    # 训练的模型.pth文件的存放地址
    parser.add_argument("--model_dir", dest="model_dir", help="directory to load models",
                        default="../data/experiments/DA_Faster_ICR_CCR/C2F/model/C2F_", type=str,)
    # begin_epoch
    parser.add_argument("--begin_epoch", dest="begin_epoch", help="begin epoch", default=15, type=str,)
    # end_epoch
    parser.add_argument("--end_epoch", dest="end_epoch", help="end epoch", default=36, type=str,)
