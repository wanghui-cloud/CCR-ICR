...
def parse_args():
    ...
    parser.add_argument("--dataset", dest="dataset", help="test dataset",
    ...
    # begin_epoch
    parser.add_argument("--begin_epoch", dest="begin_epoch", help="begin epoch", default=20, type=str, )
    # end_epoch
    parser.add_argument("--end_epoch", dest="end_epoch", help="end epoch", default=50, type=str, )
