...
class cityscapes_car(imdb):
    def __init__(self, image_set, year):
        ...
        # 数据集存储位置
        self._devkit_path = "/home/ubuntu/Documents/CR-DA-DET/DA_Faster_ICR_CCR/data/datasets/cityscapes_car"
    ...
    """
        ...
        # indices
        coco_cat_id_to_class_ind = dict([ (self._class_to_coco_cat_id[cls], self._class_to_ind[cls])
        ...
        return {"width": width, "height": height, "boxes": boxes, "gt_classes": gt_classes,
    ...
    def _coco_results_one_category(self, boxes, cat_id):
        ...
        for im_ind, index in enumerate(self.image_index):
            ...
            hs = dets[:, 3] - ys + 1
            results.extend(
                [{ "image_id": index, "category_id": cat_id,
