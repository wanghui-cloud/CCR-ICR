...
class pascal_voc_water(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        ...
        self.config = { "cleanup": True, "use_salt": True, "use_diff": False,
    ...
    def image_path_from_index(self, index):
        ...
        image_path = os.path.join(self._data_path,
                                  "JPEGImages", index + self._image_ext)
    ...
    def _do_python_eval(self, output_dir="output"):
        annopath = os.path.join(self._devkit_path,
                                "VOC" + self._year, "Annotations", "{:s}.xml")
    ...
    def _do_matlab_eval(self, output_dir="output"):
        ...
        cmd += "voc_eval('{:s}','{:s}','{:s}','{:s}'); quit;\"".format( self._devkit_path,
                                                                        self._get_comp_id(),
