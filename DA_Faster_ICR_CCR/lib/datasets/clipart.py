...
class clipart(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        ...
        self._devkit_path = (cfg_d.CLIPART)  if devkit_path is None else devkit_path
        ...
        self._classes = (
            ...
            "pottedplant", "sheep", "sofa", "train", "tvmonitor",)  # 20
        ...
        self.config = {"cleanup": True, "use_salt": True,
                       "use_diff": False, "matlab_eval": False,
    ...
    def _load_image_set_index(self):
        ...
        assert os.path.exists(image_set_file), "Path does not exist: {}"\
            .format(image_set_file)
    ...
    def _load_pascal_annotation(self, index):
        ...
        return { "boxes": boxes,"gt_classes": gt_classes,
                 "gt_ishard": ishards, "gt_overlaps": overlaps,
    ...
    def _do_python_eval(self, output_dir="output"):
        ...
        imagesetfile = os.path.join(self._devkit_path, "ImageSets", "Main",
                                    self._image_set + ".txt")
        ...
        for i, cls in enumerate(self._classes):
            if cls == "__background__":
                continue
            filename = self._get_voc_results_file_template().format(cls)
            rec, prec, ap = voc_eval( filename, annopath, imagesetfile,
