...
def parse_args():
    ...
    parser.add_argument("--dataset", help="cityscapes_car_only", default="cityscapes_car_only", type=str)
    parser.add_argument("--outdir", help="output dir for json files",
                        default="/home/ubuntu/Desktop/datasets/Cityscapes", type=str)
...
def convert_cityscapes_car_only(data_dir, out_dir):
    ...
    # data_set = "gtFine_val", "gtFine_train"
    # ann_dirs = "gtFine_trainvaltest/gtFine/val", "gtFine_trainvaltest/gtFine/train",
