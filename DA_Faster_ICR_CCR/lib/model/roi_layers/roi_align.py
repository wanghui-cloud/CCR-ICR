...
# ROI Align方法，取消整数化操作，保留了小数，使用双线性插值的方法获得坐标为浮点数的像素点上的图像数值
class _ROIAlign(Function):
    ...
    def backward(ctx, grad_output):
        ...
        grad_input = _C.roi_align_backward( grad_output, rois, spatial_scale, output_size[0],
                                            output_size[1], bs, ch, h, w, sampling_ratio,)
...
class ROIAlign(nn.Module):
    def __init__(self, output_size, spatial_scale, sampling_ratio):
        ...
        self.spatial_scale = spatial_scale    # 1.0/16.0
